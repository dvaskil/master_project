...
while true; do
    ...
    simdir=/data/graphs/human_21_and_22/output/bwa/$dir_name/simulated_output
    aligndir=/data/graphs/human_21_and_22/output/bwa/$dir_name/np_align
